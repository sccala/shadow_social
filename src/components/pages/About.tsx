...
export const About: VFC = memo(() => {
  ...
  return (
    <div className='bg-primary'>
      <div
        className='py-32 bg-cover h-screen w-screen justify-center items-center text-primary text-center grid grid-cols-6 filter dark:brightness-100 dark:grayscale-0'
        style={{
